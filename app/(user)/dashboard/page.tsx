...
import { TrendingUp, Users, Award, Wallet, ArrowUpRight, ArrowDownLeft, Target, Zap } from "lucide-react"
import { formatCurrency } from "@/lib/utils"

export default function UserDashboard() {
  const stats = [
    { label: "Pending Rewards", value: "$1,250", icon: Award, color: "text-red-500" },
    { label: "Available Balance", value: "$3,500", icon: Wallet, color: "text-green-400" },
    { label: "Total Referrals", value: "42", icon: Users, color: "text-blue-400" },
    { label: "Total Earned", value: "$8,750", icon: TrendingUp, color: "text-yellow-400" },
  ]

  const recentTransactions = [
    { id: 1, type: "credit", description: "Product Purchase Reward", amount: 250, date: "2 hours ago" },
    { id: 2, type: "debit", description: "Product Purchase", amount: -150, date: "5 hours ago" },
    { id: 3, type: "credit", description: "Referral Bonus", amount: 100, date: "1 day ago" },
    { id: 4, type: "credit", description: "Monthly Reward", amount: 500, date: "2 days ago" },
  ]

  const achievements = [
    { title: "First Purchase", description: "Made your first purchase", icon: Target },
    { title: "Referral Master", description: "Referred 10+ users", icon: Users },
                  ...
                  {recentTransactions.map((tx) => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div className={`p-2 rounded-lg ${tx.type === "credit" ? "bg-green-600/20" : "bg-red-600/20"}`}>
                          {tx.type === "credit" ? (
