...
export default function ProductDetailPage({ params }: { params: { id: string } }) {
  ...
  const product = {
    ...
    description: "Get access to all premium features and unlock unlimited potential",
    details: "This premium subscription includes all advanced features, priority support, and exclusive content.",
  }
            ...
            <div className="space-y-4">
              <div className="bg-red-900/20 border border-red-500/30 rounded-lg p-6">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <span className="text-3xl font-bold text-red-500">${(product.price / 100).toFixed(2)}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-400">Reward</span>
                  <span className="text-2xl font-bold text-green-400">+${(product.reward / 100).toFixed(2)}</span>
                </div>
              </div>
            ...
            <div className="p-8 space-y-6">
              <div>
                ...
                <p className="text-gray-400">
                  Share this product and earn ${(product.reward / 100).toFixed(2)} for each sale
                </p>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <Button className="flex-1 bg-red-600 hover:bg-red-700 text-white">Share on Social</Button>
              </div>
            </div>
          </Card>
        </div>
